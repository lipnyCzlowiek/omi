...
export class AppComponent {
	...
	constructor() {
		...
		this.obliczStratyPoWartosciStrat();
		this.obliczStratyPoLiczbieBudynkow();
	...
	obliczStratyPoWartosciStrat(value = this.input.stratyWartosc): void {
		...
		this.input.stratyLiczbaBud = '';
		this.input.stratyWartosc = value;
		this.output.e = wynik;
		this.obliczOmi();
	}
	...
	obliczStratyPoLiczbieBudynkow(value = this.input.stratyLiczbaBud): void {
		...
		this.input.stratyWartosc = '';
		this.input.stratyLiczbaBud = value;
		this.output.e = wynik;
		this.obliczOmi();
	}
